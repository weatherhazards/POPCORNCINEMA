...
ai = {
    ...
    AGGRESSION_BASE = 1, -- general AI aggression CWEWW note I dont think this works?
    ALICE_AI_THREAT_OVERESTIMATE = 4 -- supposedly the real aggression modifier
    AGGRESSION_UNCIV_BONUS = 1, -- additional AI civ aggression against uncivs
